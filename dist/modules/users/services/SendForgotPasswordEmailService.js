...
var _IEmailProvider = _interopRequireDefault(require("../../../shared/container/providers/MailProvider/models/IEmailProvider"));
...
let SendForgotPasswordEmailService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!user) {
      throw new _AppError.default('User doest not exists.');
    }
