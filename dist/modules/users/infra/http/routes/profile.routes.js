...
const profileController = new _ProfileController.default(); // autenticação

profileRouter.use(_ensureAuthenticated.default); // rota de show profile

profileRouter.get('/', profileController.show); // rota de update profile
